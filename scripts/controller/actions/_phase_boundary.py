"""Facade — _phase_boundary.py split into scripts.controller.actions.phase.*."""
from scripts.controller.actions.phase.boundary import *  # noqa: F401,F403
from scripts.controller.actions.phase.boundary import (  # noqa: F401
