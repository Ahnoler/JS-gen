...
from scripts.controller.actions.phase.intent import (  # noqa: F401
    ...
    append_contract_history, apply_phase_contract, apply_phase_intent, check_pending_write_gate,
    classify_task_mode, clear_phase_intent, compile_phase_intent, contract_allows_form_assistant,
    contract_force_refill, contract_summary_hint, emit_phase_observability, ensure_contract_version,
    force_refill_all_required, get_active_contract, get_phase_intent,
