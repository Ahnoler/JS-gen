"""SelectEngine — split from form_action_engines.py (S5)."""
...
from ._helpers import (
    ...
    attach_select_options, reset_select_ui,
    stamp_recorded_xpath_smart,
)
from ._js_snippets import (
    JS_SELECT_OPTION,
    JS_SELECT_TRIGGER_BY_XPATH, JS_SELECT_VALUE_BY_XPATH,
...
from .replay_timing import WAIT_500_MS, budget_for
