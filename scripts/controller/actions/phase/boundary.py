"""Facade — boundary.py split into contract/gates halves."""
from scripts.controller.actions.phase.boundary_contract import *  # noqa: F401,F403
from scripts.controller.actions.phase.boundary_contract import (  # noqa: F401
    ...
    boundary_to_legacy_intent, classify_task_mode, clear_phase_boundary, compile_boundary,
    contract_summary_hint_boundary, force_refill_all_required, get_phase_boundary, is_login_task,
    is_open_page_task, is_query_task, is_wizard_nav_task, phase_boundary_active,
    phase_boundary_enabled, re,
)
from scripts.controller.actions.phase.boundary_gates import *  # noqa: F401,F403
