...
(async () => {
  ...
  // Inject CTRL helpers — single source of truth: src/ctrl-actions.js
  // Full CTRL object is generated by script_assembler.py or getInjectionCode()
  // This ensures generated scripts always use the latest CTRL implementations.
  // See src/ctrl-actions.js for the authoritative CTRL function definitions.
