    ...
    endpoints: [
      ...
      },
      {
        ...
        respExample: J({
          ...
          element: {
            tag: 'li',
            xpath: "//li[contains(@class,'menu-item')][contains(normalize-space(.),'对公客户管理')]",
            xpath_smart: "//li[contains(@class,'menu-item')][contains(normalize-space(.),'对公客户管理')]",
            xpath_full: '/div[1]/aside[1]/ul[1]/li[2]',
            cssSelector: 'li.menu-item',
            ...
            candidates: [
              { type: 'xpath_smart', value: "//li[contains(@class,'menu-item')][contains(normalize-space(.),'对公客户管理')]" },
              { type: 'xpath_full', value: '/div[1]/aside[1]/ul[1]/li[2]' },
            ],
          },
        }),
        notes: [
