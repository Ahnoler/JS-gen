 ...
 * whose version differs (STALE_PROPOSE_CACHE). v7: atomize prompt/taskDraft
 * semantics — project parsed through-chains/chapter detail; thin input stays
 * G1–G3 length (do not hallucinate prototype UI strings). v6: capability-cohesion
 ...
 */
export const PROPOSE_CACHE_VERSION = 7;
