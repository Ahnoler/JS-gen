...
| **contract-sovereignty-wet** | P3 已闭 | Task 8 全闭：主路径 traj **754**；字面 `done_rejected` traj **758**（stderr+events）；planner filter 接线 + 湿 discard traj **762**；报告 [`reports/2026-09-11-contract-sovereignty-wet.md`](reports/2026-09-11-contract-sovereignty-wet.md)。可选遗留：Premature vs gate 双层语义文档；out_of_scope 触碰丢弃规格未全实装 |
