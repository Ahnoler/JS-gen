...
- 五卡齐；库/查询/要素 13 条此前已 SQL 改挂 0740/0467/0468。
- **阶段/映射**：新建 `9000000811`/`9000000812`；8 条 traj 已迁离 0230；幽灵 0230/0231 `removed_flag=1`。
- 扫描：`buildScanApplyPlan` L2 xpath(data-id) 优先 + 错名改名；禁止同名覆盖异 xpath。
