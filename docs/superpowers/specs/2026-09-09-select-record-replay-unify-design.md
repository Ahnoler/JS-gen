...
**日期**：2026-09-09  
**状态**：A+B 已落地（`select_dispatch` + 回放经 `SelectEngine`/`TreeEngine` `mode=replay`）— 计划 [`../plans/2026-09-09-select-record-replay-unify.md`](../plans/2026-09-09-select-record-replay-unify.md)  
